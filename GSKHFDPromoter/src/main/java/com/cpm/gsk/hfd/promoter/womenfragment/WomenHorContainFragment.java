...
public class WomenHorContainFragment extends Fragment {
  ...
  FragmentManager fragmentManager;
    ...
    public WomenHorContainFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_women_hor_contain, container, false);
        Button button = (Button) view.findViewById(R.id.nxt_btn);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                WomenHorLiteFragment fragment=new WomenHorLiteFragment();
