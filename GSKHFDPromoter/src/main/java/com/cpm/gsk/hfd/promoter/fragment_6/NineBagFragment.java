...
import com.cpm.gsk.hfd.promoter.fragment.PredisureMoreOptFragment;
import com.cpm.gsk.hfd.promoter.skufragment.SkuFragment;

public class NineBagFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nine_bag, container, false);
        ...
        switch (id) {
            case R.id.btn_yes:
               ...
               AdviseFragment fragment1=new AdviseFragment();
                ...
                break;
            case R.id.btn_no:
                SomeTimeFragment fragment = new SomeTimeFragment();
