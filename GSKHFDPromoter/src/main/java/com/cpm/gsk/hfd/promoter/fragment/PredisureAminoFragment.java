...
public class PredisureAminoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_predisure_amino, container, false);
        ...
        nxt_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view1) {
                ...
                switch (id) {
                    case R.id.nxt_btn:
                        PredisureHorGrowthFragment fragment = new PredisureHorGrowthFragment();
