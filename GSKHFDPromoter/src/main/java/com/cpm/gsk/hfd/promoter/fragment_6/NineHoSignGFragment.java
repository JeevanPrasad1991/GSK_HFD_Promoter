...
public class NineHoSignGFragment extends Fragment {
   ...
   FragmentManager fragmentManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_nine_ho_sign_g, container, false);
        Button nxt = (Button) view.findViewById(R.id.nxt_btn);
        nxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

               NineHBenifitFragment adviseFragment = new NineHBenifitFragment();
