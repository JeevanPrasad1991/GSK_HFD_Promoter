...
public class AllProductFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        img_juniH = (ImageView) view.findViewById(R.id.img_juniH3);
        img_pedisure = (ImageView) view.findViewById(R.id.img_pedisure3);
        img_champ = (ImageView) view.findViewById(R.id.img_champ3);
        img_complain = (ImageView) view.findViewById(R.id.img_complain3);
        img_horlicks = (ImageView) view.findViewById(R.id.img_horlicks3);
        img_other = (ImageView) view.findViewById(R.id.img_other3);
        img_firsttime = (ImageView) view.findViewById(R.id.img_firsttime3);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            case R.id.img_juniH3:
                ...
                break;
            case R.id.img_pedisure3:
                HorlicksImproovFragment fragment1 = new HorlicksImproovFragment();
                fragmentManager.beginTransaction().replace(R.id.container, fragment1).
                        addToBackStack(String.valueOf(fragmentManager.getFragments())).commit();
                break;
            case R.id.img_champ3:
                TransiterFragment fragment2 = new TransiterFragment();
                fragmentManager.beginTransaction().replace(R.id.container, fragment2)
                        .addToBackStack(String.valueOf(fragmentManager.getFragments())).commit();
                break;


            case R.id.img_complain3:
                HighWFragment fragment3=new HighWFragment();
               fragmentManager.beginTransaction().replace(R.id.container, fragment3)
                       .addToBackStack(String.valueOf(fragmentManager.getFragments())).commit();
                break;
            case R.id.img_other3:
                HighWFragment fragment4=new HighWFragment();
             fragmentManager.beginTransaction().replace(R.id.container, fragment4)
                     .addToBackStack(String.valueOf(fragmentManager.getFragments())).commit();
                break;


            case R.id.img_firsttime3:
                StaminaFragment staminaFragment=new StaminaFragment();
              fragmentManager.beginTransaction().replace(R.id.container, staminaFragment)
                      .addToBackStack(String.valueOf(fragmentManager.getFragments())).commit();
                break;
            case R.id.img_horlicks3:
             SignGrowthFragment fragment5=new SignGrowthFragment();
