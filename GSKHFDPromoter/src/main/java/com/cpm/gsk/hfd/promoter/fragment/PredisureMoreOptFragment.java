...
public class PredisureMoreOptFragment extends Fragment {
    ...
    public PredisureMoreOptFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_predisure_more_opt, container, false);
