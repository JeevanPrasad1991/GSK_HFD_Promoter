...
import com.cpm.gsk.hfd.promoter.tenplusfragment.FlaourFragment;

public class HorlickLiteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_horlick_lite, container, false);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentManager.beginTransaction().replace(R.id.container, fragment).addToBackStack(String.valueOf(fragmentManager.getFragments()))
                        .commit();
             /*  // HLiteFlavours frLiteFlavours = new HLiteFlavours();
                fragmentManager.beginTransaction().replace(R.id.container, frLiteFlavours).commit();*/
            }
        });
        return view;
