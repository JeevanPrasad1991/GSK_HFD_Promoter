...
public class NineBoostBenefitFragment extends Fragment {
  ...
  FragmentManager fragmentManager;
    ...
    public NineBoostBenefitFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_nine_boost_benefit, container, false);
        Button nxt = (Button) view.findViewById(R.id.nxt_btn);
        nxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NineBoostRangeFragment fragment=new NineBoostRangeFragment();
