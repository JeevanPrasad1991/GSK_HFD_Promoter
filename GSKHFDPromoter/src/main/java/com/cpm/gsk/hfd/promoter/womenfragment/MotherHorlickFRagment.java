...
public class MotherHorlickFRagment extends Fragment {
   ...
   FragmentManager fragmentManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_mother_horlick_fragment, container, false);
        Button button = (Button) view.findViewById(R.id.nxt_btn);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MotherHFlavourFragment fragment=new MotherHFlavourFragment();
